...
namespace FBSMovilCBWebApi.Dominio.Servicios.PagoServisios.Queries
{
    public class ObtenerFormatosHandler : IRequestHandler<ObtenerFormatosME, FormatoMS>
    {
        ...
        public ObtenerFormatosHandler(IFBSCorresponsalesApi facilitoApi, IMapper mapper, IMediator mediador, IApiKeyGenerator apiKeyGenerator, IRepositorioAgente repositorioAgente, IJsonConfiguracion jsonConfiguracion)
        {
