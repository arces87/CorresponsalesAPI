...
{
    public class AbrirDiaHandler : IRequestHandler<AbrirDiaME, bool>
    {
        ...
        public AbrirDiaHandler(IMediator mediador, IRepositorioAgente repositorioAgente, IMapper mapper,
        ...
        public async Task<bool> Handle(AbrirDiaME request, CancellationToken cancellationToken)
        {
