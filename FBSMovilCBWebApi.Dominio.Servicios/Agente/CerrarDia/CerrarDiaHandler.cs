    ...
    public class CerrarDiaHandler : IRequestHandler<CerrarDiaME, bool>
    {
        ...
        public async Task<bool> Handle(CerrarDiaME request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                //    else
                //    {
                //        throw new ExcepcionApp("Error en la validación de los datos de autenticación | A002");
                //    }
                //}
                //throw new ExcepcionApp("Error en la validación de los datos de autenticación | A001");
            }
            catch (Exception)
            {
